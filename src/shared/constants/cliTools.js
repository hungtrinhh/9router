...
export const MITM_TOOLS = {
  antigravity: {
    ...
    modelAliases: ["gemini-3.8-flash-high", "gemini-3.8-flash-medium", "gemini-3.8-flash-low", "gemini-3.8-flash", "gemini-3.7-flash-high", "gemini-3.7-flash-medium", "gemini-3.7-flash-low", "gemini-3.6-flash-high", "gemini-3.6-flash-medium", "gemini-3.6-flash-low", "gemini-3.5-flash-high", "gemini-3.5-flash-low", "gemini-3-flash-agent", "gemini-3.5-flash-extra-low", "gemini-3.1-pro-low", "gemini-3.1-pro-high", "gemini-pro-agent", "gemini-3.1-flash-lite", "claude-sonnet-4-6", "claude-opus-4-6-thinking", "gpt-oss-120b-medium", "gemini-3-flash", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-3.1-flash-image"],
    defaultModels: [
      ...
      { id: "gemini-3.1-flash-lite", name: "Gemini 3.1 Flash Lite", alias: "gemini-3.1-flash-lite" },
      ...
      { id: "gemini-3.1-flash-image", name: "Gemini 3.1 Flash (Image)", alias: "gemini-3.1-flash-image" },
    ],
  },
  copilot: {
    id: "copilot",
